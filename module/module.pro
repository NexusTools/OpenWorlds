...
win32:CONFIG(release, debug|release): LIBS += -L$$OUT_PWD/../extern/MoeGameEngine/lib/release/ -lMoeGameEngine
else:win32:CONFIG(debug, debug|release): LIBS += -L$$OUT_PWD/../extern/MoeGameEngine/lib/debug/ -lMoeGameEngine
...
win32:CONFIG(release, debug|release): LIBS += -L$$OUT_PWD/../extern/MoeGameEngine/extern/ModularCore/release/ -lModularCore
else:win32:CONFIG(debug, debug|release): LIBS += -L$$OUT_PWD/../extern/MoeGameEngine/extern/ModularCore/debug/ -lModularCore
